...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_task1.setText(_translate("MainWindow", "Pick 'n sort!", None))
        self.btn_task2.setText(_translate("MainWindow", "Pick 'n stack!", None))
        self.btn_task3.setText(_translate("MainWindow", "Line 'em up!", None))
        self.btn_task4.setText(_translate("MainWindow", "Stack 'em high!", None))
        self.btn_task5.setText(_translate("MainWindow", "To the sky!", None))
